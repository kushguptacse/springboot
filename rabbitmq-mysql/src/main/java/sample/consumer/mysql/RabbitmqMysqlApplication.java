...
import sample.consumer.mysql.config.ApplicationConfigReader;

@SpringBootApplication
public class RabbitmqMysqlApplication {

	@Autowired
	private ApplicationConfigReader applicationConfigReader; 
	
	public static void main(String[] args) {
		SpringApplication.run(RabbitmqMysqlApplication.class, args);
	}
